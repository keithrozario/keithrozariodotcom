...
<h2>If you find it you get to name it</h2>
...
<h2>So who found the router</h2>
So if you want to determine whether it's Rao-ter or Root-er, you simply have to reference the culture that invented the router, and that's the Americans. The modern router is built off the<a title="What is I.T: IP address (part 1)" href="http://www.keithrozario.com/2013/09/what-is-it-ip-address.html"> Internet Protocol which was developed by the US Department-of-Defense</a>.
