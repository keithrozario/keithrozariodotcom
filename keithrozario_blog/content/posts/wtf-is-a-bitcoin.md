...
So the best way to think of bitcoin is to treat it as <strong>digital gold</strong> rather than digital currency.<!--more-->
<h2>So what's the Gold part of it</h2>
...
The bitcoin challenge makes it so that the supply of bitcoin is controlled, if the challenges start to get solved much quicker than 10 minutes, the entire system automatically adjust to make the challenges harder, thereby limiting the supply to 25 bitcoins every 10 minutes. This guarantees the supply of bitcoin and its rarity, which is what gives it value.
<h2>So why are governments afraid of bitcoin</h2>
