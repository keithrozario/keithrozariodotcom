...
draft = false
aliases = ["/2013/12/proton-has-a-volvo-like-obsession-with-safety-no.html"]
categories = ['Misc']
+++
...
We were told at a briefing in Shah Alam last Friday that there are 17 changes made to the Accord, mostly - but not all - cosmetics. On the 2.0L version, for example, the Perdana is fitted with FOUR airbags instead of the original Accord's TWO (this <strong>Volvo-like obsession in safety aspects</strong> is something Proton will emphasize in future cars).
