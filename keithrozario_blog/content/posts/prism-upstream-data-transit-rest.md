...
<a href="/uploads/PRISM-and-Upstream.jpg"><img class="size-full wp-image-3712 alignleft" style="margin-right: 10px; " alt="PRISM and Upstream" src="/uploads/PRISM-and-Upstream.jpg" width="460" height="345" /></a> What the crudely drawn powerpoint on the left is trying to describe is the distinct-ness of the programs and how each program would complement (rather than replace) the other.
