...
date = "2026-02-25T11:08:09+08:00"
draft = false
categories = []
description = ""
...
A Centaur is Human brain on a horse's body, harnessing the intelligence of a human and the tireless nature of a strong horse. It's analogous to someone using AI to automate not just the boring stuff, but the harder more interesting problems as well. It's a chess player using a powerful AI to make them a better player, letting AI show them the best moves that they otherwise would not be able to find.
...
Reverse-Centaurs aren't just reserved for some dystopian future or far away land built by Bezos, I predict that reverse centaurs will proliferate as AI pervades more facets of our lives and we need to be on high alert if we ever accidentally become one, just like what happened to me last week.
...
Last year people said "You won't be replaced by AI, but by someone using AI". But why? 

Why won't AI be able to replace me? Maybe not now, or next year, but what about in 5 or 10 years from today? 

Is there some fundamental law of nature and physics that prevents an entirely AI worker from doing my work? I used to think so ... I don't anymore.
...
This is classic depiction of a Centaur. Humans and AI teaming up, and by their powers combined result in a more powerful force than either of them alone.
...
Technology changes, requirements change, regulatory framework all change, and these all can't fit into a single 'context window'. 

All true, but that doesn't mean that humans will always be required.

In 2007, about a decade after Deep Blue defeated Kasparov, a computer science professor told me:
...
Barely a decade after that conversation, my current employer, Google, released a bot that beat the worlds best Go player, a game considered by many at the time to be unplayable by computers.Taking comfort in the limits of technology isn't a good idea.
