...
![Writing an email to TMs CEO about my faulty Unifi](/uploads/Writing-an-email-to-TMs-CEO-about-my-faulty-Unifi.png)
...
The supposed 'name' of the commenter was 'Maxis Agent' and the email address given was maxis@maxis.com.my. I'm not entirely sure what to make of the comment, but this obviously wasn't the work of a Maxis agent. <a title="Email maxis agent" href="mailto:maxis@maxis.com.my" target="_blank"><strong>
</strong></a>
...
That applies to you 'Maxis Agent' that posted on my blog at 7.18pm Malaysian time from IP Address 58.27.115.118. Why would a 'Maxis' agent, post from a<a title="Telekom Malaysia IP address" href="http://www.infosniper.net/index.php?ip_address=58.27.115.118&amp;map_source=1&amp;overview_map=1&amp;lang=1&amp;map_type=1&amp;zoom_level=7" target="_blank"> TM IP address</a>?