+++
title = "10 Strange things about the ICANN Generic Top Level Domains (gTLD)"
...
<h2>10 strange things about the ICANN Top Level Domain Request</h2>
...
6. Apple made just one request, for the .APPLE top level domain. They're really walking the talk when it comes to Simplicity. <strong>Google made 101 request, Apple made just 1.</strong>

<strong></strong>7. Amazon and Google will compete with each other for 21 different top level domains, including the .APP, .BOOK, .BUY, .CLOUD , .DEV , .DRIVE , .FREE, .GAME, .MAIL, .MAP , .MOVIE , .MUSIC, .PLAY , .SEARCH , .SHOP, .SHOW , .SPOT, .STORE, .TALK , .WOW and .YOU. (I only counted the romanized script top level domains)
...
<ul>
	<li>The .SWISS Top Level Domain by the Swiss Confederation and Swiss international airlines</li>
	<li>The .MONSTER Top Level Domain by the job seeking company <a title="http://www.about-monster.com/" href="http://www.about-monster.com/" target="_blank">Monster</a>, and the Audio Cable company <a title="http://www.monsterproducts.com/" href="http://www.monsterproducts.com/" target="_blank">Monster</a></li>
	<li>The .DOC Top Level Domain where Microsoft and Google will duel to the death :</li>
</ul>
...
The full list of the ICANN request for top level domains can be found<a title="http://newgtlds.icann.org/en/program-status/application-results/strings-1200utc-13jun12-en" href="http://newgtlds.icann.org/en/program-status/application-results/strings-1200utc-13jun12-en" target="_blank"> here</a>.