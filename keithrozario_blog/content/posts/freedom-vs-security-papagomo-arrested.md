...
Notice it isn't the actual rate of crime that drives these behaviours, it's the <strong>perceived</strong> rate of crime that causes people to give up their freedoms (and a whole load of cash) in order to live in them.
