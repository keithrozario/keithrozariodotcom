...
<a title="Wordpress on Amazon Web Services" href="http://www.keithrozario.com/2011/10/wordpress-on-aws.html"><img class="alignleft size-medium wp-image-1286" title="amazon-cloud_320" src="/uploads/amazon-cloud_320-300x225.jpg" alt="" width="300" height="225" /></a>A couple of days ago, I met some guys from Amazon web services strutting their stuff out in a brilliant presentation about <strong>cloud computing</strong>. Now I must admit I haven't been the most ardent cloud computing follower (I wasn't really sure what it meant) , but I was 'converted' by these guys....to the point where I wanted to dive in and learn about the cloud.
...
<a href="/uploads/Step1_Launch_instance.jpg"><img class="alignnone size-full wp-image-1262" title="Step1_Launch_instance" src="/uploads/Step1_Launch_instance.jpg" alt="" width="486" height="166" /></a>
<h2><strong>Choose an Image</strong></h2>
<a href="/uploads/Step2_Choose_AMI.jpg"><img class="alignleft size-medium wp-image-1263" title="Step2_Choose_AMI" src="/uploads/Step2_Choose_AMI-300x124.jpg" alt="" width="300" height="124" /></a> The Next step is to choose an image, and for a wordpress site I chose one of the bitnami images. Now you can choose almost any image you wish for, but I went for the <span style="color: #888888;"><em>979382823631/bitnami-wordpress-3.2.1-0-linux-ubuntu-10.04</em></span>. If for any reason you feel like you need an older version of wordpress or a different version of Linux, then feel free to go for it. However, the rest of this tutorial/testimonial will deal specifically with this image only, so some steps may vary, but overall it's pretty standard.
<h2><strong>Select Instance details</strong></h2>
Once I picked out an image,<a href="/uploads/Step3_InstanceDetails.jpg"><img class="alignleft size-medium wp-image-1264" title="Step3_InstanceDetails" src="/uploads/Step3_InstanceDetails-300x117.jpg" alt="" width="300" height="117" /></a> Amazon needs to know what kind of machine you want to run this on. Now you can run it on just about any machine you want, but only the <strong>Micro (t1.micro, 613MB)</strong> machine is free for year....so if you don't know which one to pick, pick this one...remember Amazon has your Credit Card and it will charge you if you pick the wrong machine, and if you do and get charged, well it's your fault now isn't it?
<h2><strong>Specify</strong><strong><strong> Instance details</strong></strong></h2>
N<a href="/uploads/Step3_InstanceDetails.jpg"><img class="alignleft size-medium wp-image-1264" title="Step3_InstanceDetails" src="/uploads/Step3_InstanceDetails-300x117.jpg" alt="" width="300" height="117" /></a>ext you need to specify the instance details, so far so good. In this case all you really need to do is press next.
...
<a href="/uploads/Step5_Tags.jpg"><img class="alignleft size-medium wp-image-1266" title="Step5_Tags" src="/uploads/Step5_Tags-300x101.jpg" alt="" width="300" height="101" /></a> Here you can specify tag for your keys, these keys will be tied to an instance for you to access the image later on. For now you can leave it blank, and I would strongly recommend you leave it this way.

&nbsp;

&nbsp;
<h2><strong>Create a Key Pair</strong></h2>
<a href="/uploads/Step6_Create_Key_Pair.jpg"><img class="alignleft size-medium wp-image-1267" title="Step6_Create_Key_Pair" src="/uploads/Step6_Create_Key_Pair-300x109.jpg" alt="" width="300" height="109" /></a> A key pair is quite possibly your only way to securely access your instance, so be careful here. Here I created a key pair called keithsWPkey, and it's pretty simple to execute. Just create a key pair and amazon will create it and immediately you'll begin downloading a <strong>.pem</strong> file, now this is you local file. Amazon has another <strong>.pem</strong> file stored on it's servers. When you logon you will use your .pem file and amazon will validate that against it's own, if the .pem files match, you're good to go. If not you'll be denied access. So remember to store the .pem file safely and securely.
<h2><strong><strong>Create a Security Group</strong></strong></h2>
<a href="/uploads/Step7_Security_Group.jpg"><img class="alignleft size-medium wp-image-1268" title="Step7_Security_Group" src="/uploads/Step7_Security_Group-300x171.jpg" alt="" width="300" height="171" /></a>Creating a security group helps control who can access your image and how. Amazons default security profile blocks all traffic, so it's not really that useful. You'll need to create your own security profile, for wordpress you'll at least need the following ports open, <strong>22</strong> (for sFTP and SSH),<strong> 80</strong> (for http access to your blog) and <strong>443</strong> (for https access).
...
<a href="/uploads/Step8_Launch.jpg"><img class="alignleft size-medium wp-image-1269" title="Step8_Launch" src="/uploads/Step8_Launch-300x157.jpg" alt="" width="300" height="157" /></a>Now click on next, and just before you launch you may want to check on the following items:
...
<a href="/uploads/Step9_Elastic_Ip.jpg"><img class="alignleft size-medium wp-image-1270" title="Step9_Elastic_Ip" src="/uploads/Step9_Elastic_Ip-300x71.jpg" alt="" width="300" height="71" /></a>Now that you've got the instance running, it will have a url, signified by Publich DNS field in your instance details. Now you need an IP address for it, so head on over to the Elastic IP part of your AWS management console <em>(it's in your EC2, to the left, under Network and Security)</em> and get your IP by hitting the <strong>'Allocate New Address'</strong> button.
...
<a href="/uploads/Step10_AssociateAddress.jpg"><img class="alignleft size-medium wp-image-1271" title="Step10_AssociateAddress" src="/uploads/Step10_AssociateAddress-300x133.jpg" alt="" width="300" height="133" /></a>Now that you have an IP, it'll be simple to associate an instance to it. If you are brand new to AWS, then you should only have one instance running and that's the one you want to associate with your brand new elastic IP. After you've completed this step it's pretty simple, the IP address given is now associated to your EC2 (which should be running wordpress). So head on over to the IP address and you'll see a bitnami page.
...
<p style="text-align: center;"><a href="/uploads/Step12_Setup_Wordpress.jpg"><img class="size-full wp-image-1278 aligncenter" title="Step12_Setup_Wordpress" src="/uploads/Step12_Setup_Wordpress.jpg" alt="" width="497" height="205" /></a><strong><strong><strong><strong><strong><strong><strong>
...
<a href="/uploads/Step13_Login.jpg"><img class="aligncenter size-full wp-image-1279" title="Step13_Login" src="/uploads/Step13_Login.jpg" alt="" width="366" height="342" /></a>Now for the particular AMI I chose, the username and password for the image are :
...
<p style="text-align: left;"><a href="/uploads/CNAME.jpg"><img class="aligncenter size-full wp-image-1280" title="CNAME" src="/uploads/CNAME.jpg" alt="" width="676" height="39" /></a></p>
...
<a href="/uploads/PuttyGen.jpg"><img class="aligncenter size-full wp-image-1281" title="PuttyGen" src="/uploads/PuttyGen.jpg" alt="" width="329" height="213" /></a>
...
<a href="/uploads/Putty.jpg"><img class="alignleft size-full wp-image-1282" title="Putty" src="/uploads/Putty.jpg" alt="" width="373" height="357" /></a>So now that everything is good to go, you've got a second bit of work you need to do. That is to access your machine. To do this, fire up your Putty instance.
...
<a href="/uploads/WinSCP_Login.jpg"><img class="alignleft size-full wp-image-1284" title="WinSCP_Login" src="/uploads/WinSCP_Login.jpg" alt="" width="317" height="223" /></a> The create a new session. For the host name, enter your host name..i.e the Public DNS. Port number 22 (that's for SSH) and enter 'bitnami' as the username.
