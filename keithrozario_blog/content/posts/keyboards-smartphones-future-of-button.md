...
When a new phone hits the market, we tend to get terribly excited about its new features. And rightly so: what are boundaries for, if not to push frantically? But with the release of the latest <a title="Blackberry 10 Handset" href="http://www.blackberry.com.my/software/smartphones/blackberry-10-os.html" target="_blank">BlackBerry 10</a> handsets, perhaps the most important contribution to the future of the smartphone might come in the form of the continuing inclusion of an actual QWERTY keyboard.
